...
namespace CrimeAlert.Web.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: CrimeAlert.Web.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult Login(CrimeAlert.Web.Models.LoginModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Login);
